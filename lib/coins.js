// @flow
export const coinSymbols = ["BTC","XRP","ETH","BCH","ADA","XLM","LTC","XEM","DASH","XMR","NEO","EOS","TRX","BTG","QTUM","ETC","XRB","ICX","LSK","BTS","XVG","OMG","STEEM","SNT","ARDR","ZEC","PPT","STRAT","USDT","WAVES","BCN","HSR","DOGE","KMD","SC","GNT","BNB","REP","VEN","ARK","VERI","DCR","KCS","SALT","DRGN","DGB","PIVX","NXT","BAT","FCT","MONA","AION","MAID","GBYTE","POWR","RDD","REQ","ENG","XZC","BTCD","XP","ZRX","CVC","KNC","ETN","PAY","FUN","SYS","BTM","WAX","RHOC","SAN","QASH","MANA","KIN","AE","XBY","DGD","SKY","VTC","BAY","GAS","DENT","STORJ","SUB","GAME","ELF","ICN","GNO","CTR","QSP","UBQ","ITC","RDN","WTC","BNT","LINK","STORM","EDG","BLOCK","POE","CNX","SMART","NAV","TRIG","TNB","DATA","RPX","MCO","EMC2","R","RCN","CMT","LEND","SNGLS","MTL","ENJ","NXS","ZCL","ANT","ADX","PART","CLOAK","ZEN","CND","PPP","DCN","VEE","RLC","SNM","XDN","RISE","PPC","PAC","LRC","UKG","UTK","EMC","TNT","1ST","DCT","THC","AGRS","VOX","QRL","LBC","GRS","MGO","MED","ECA","BRD","DNT","FUEL","WGR","ACT","WABI","AMB","SRN","XAS","DBC","ETP","CFI","MOD","XSPEC","WINGS","VIA","NLG","ATM","NEBL","GUP","EDO","PLR","AEON","PURA","MER","XCP","HMQ","CDT","SHIFT","MLN","PRE","BURST","YOYOW","SLS","AST","VIB","FTC","GTO","DMD","POT","PASC","SIB","BITCNY","ADT","MOON","TRST","COB","MNX","SPANK","XSH","AMP","BLK","DTR","MTH","NLC2","HEAT","CRW","XEL","NMC","ION","PEPECASH","FAIR","PPY","LUN","IOC","BTX","TAAS","LA","DLT","LKK","OMNI","TKN","XWC","GRC","NULS","DRT","ZSC","TIX","RVT","MDA","MSP","SNOV","LMC","MUE","OK","DBET","NET","COLX","SBD","NMR"]; // eslint-disable-line
